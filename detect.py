...
URL='http://192.168.88.22:8080/stream?topic=/camera/rgb/image_raw&width=640&height=480&quality=50'
...
def main(image):
    ...
    # if res_area == g_area: #TODO Check if not moving part prevents command from looping and helps
    #     infinite_forward()
    #     moving = True
    
    print(f"reserved area - {res_area}")
    print(moving)
