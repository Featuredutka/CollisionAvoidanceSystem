...
drs['moderate'] = fuzz.trimf(robot_speed.universe, [0.2, 0.6, 0.8])
...
#3
rule5 = ctrl.Rule(person_dist['far'], drs['moderate'])
#4 IN PROGRESS (BITWISE LOGIC)
rule6 = ctrl.Rule(person_dist['near'] | sign_det['yes'], drs['low'])
